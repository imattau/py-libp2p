...
class HopMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limit", b"limit", "peer", b"peer", "reservation", b"reservation", "status", b"status", "type", b"type"]) -> builtins.bool: ...
...
class StopMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limit", b"limit", "peer", b"peer", "status", b"status", "type", b"type"]) -> builtins.bool: ...
